    ...
    <div className="App">
      ...
      <header className="App-header">
        <Switch>
          ...
          <Route exact path={process.env.PUBLIC_URL + '/projects/project1'} component={Project1} />
          <Route exact path={process.env.PUBLIC_URL + '/projects/project2'} component={Project2} />
        </Switch>
      </header>
    </div>
  );
